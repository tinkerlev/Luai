...
const DecorativeBlur = ({isDarkTheme = false}) => {
  console.log('DecorativeBlur', isDarkTheme);
  ...
  return (
      ...
      {/* <div
        style={{}}
        className={`fixed animate-spin** bottom-0 right-[-10vw] w-1/2 h-1/4 rounded-full bg-gradient-to-r from-[oklch(var(--p))]/10 to-accent/10 blur-[100px]`}
      /> */}
    </div>
  );
}